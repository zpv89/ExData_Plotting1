## This is the script to produce plot 4 for the first assignment of the exploratory data analysis course
...
#plot2
plot(DateSubset$DateTime,as.numeric(DateSubset$Voltage),type="l",xlab="Date-Time",ylab = "Voltage")
...
#plot4
plot(DateSubset$DateTime,as.numeric(DateSubset$Global_reactive_power),type="l",xlab = "Date-Time",ylab = "Global_Reactive_Power")
